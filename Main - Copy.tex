...
\textbf{DECLARATION}\\
\end{center}
I hereby declare that the seminar report \textbf{“SEMINARTOPIC”} , 
...
\end{center}
% him/her => 
This is to certify that the report entitled \textbf{ \large SEMINARTOPIC} 
...
SEMINARTOPIC (also known as EUV or EUVL) 
...
SEMINARTOPIC (EUVL) technology and 
...
\bibitem{ref1}R. H. Stulen and D. W. Sweeney, "SEMINARTOPIC," in IEEE Journal of Quantum Electronics, 
      vol. 35, no. 5, pp. 694-699, doi: 10.1109/3.760315.

\bibitem{ref2}P. Tao et al., "Photoresist for SEMINARTOPIC,"  (IWAPS), 2020, pp. 1-4, 
